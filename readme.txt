...
Installing "Portfolio to Projects Converter" can be done either by searching for "Portfolio to Projects Converter" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
